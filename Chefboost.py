...
def fit(df, config = {}, target_label = 'Decision', validation_df = None):
	...
	if df.columns[-1] != 'Decision':
		if 'Decision' in df.columns:
			...
			raise ValueError('Please set the target_label', df.columns[-1])
